...
def main():
    ...
    @st.cache_data
    def load_kmeans(_sample, _id, _mdl):
        index = sample[sample.index == int(_id)].index.values
        index = index[0]
    ...
    st.markdown('***')
    st.markdown("Si vous aimez ce Dashboard n'hésitez pas à me laisser un commentaire en cliquant sur le lien suivant *Code from [Github](https://github.com/u0733172/Pret-a-depenser.git)* ❤️")
